...
namespace CooperativaMVC.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,TaxaComissao,Matricula,SalarioBase")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,TaxaComissao,Matricula,SalarioBase")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
