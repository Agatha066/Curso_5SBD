...
namespace CarroCRUD.Controllers
{
    public class PagamentosController : Controller
    {
        ...
        public PagamentosController(BancoDeDados context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PagamentoId,NomeTitular,NumeroCartao,DataValidade,CVV")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PagamentoId,NomeTitular,NumeroCartao,DataValidade,CVV")] Pagamento pagamento)
        {
